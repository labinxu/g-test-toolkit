export declare class CustomLogger {
    ...
    private context;
    private clientId;
    constructor(winstonLogger: winston.Logger, loggerGateway: LoggerGateway, clientId?: string);
    format(level: string, message: string): string;
    setContext(context: string): void;
    addLogFileTransports(filename: string): winston.transports.FileTransportInstance;
    removeLogFileTransports(transport: winston.transports.FileTransportInstance): void;
...
export declare class BrowserHelper {
    private broweres;
    newBrowser({ logger, headless, timeout, domain, retry, }: {
        logger: any;
        headless: boolean;
        timeout: number;
        domain?: string;
