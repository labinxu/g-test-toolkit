...
export class AuthController {
  ...
  @Post('login')
  async login(@Body() loginDto: LoginDto, @Req() req: FastifyRequest, @Res() res: FastifyReply) {
    try {
  ...
  async logout(@Res() res: FastifyReply) {
    ...
    return res.status(HttpStatus.OK).send({ status: 'successful', message: 'Logout successful' })
  }
